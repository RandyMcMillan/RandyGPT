use crate::config::{MAX_ITERS, BPE_VOCAB_SIZE, BPE_VOCAB_PATH, LEARNING_RATE, MIN_LEARNING_RATE, GRAD_CLIP, EARLY_STOP_PATIENCE, MAX_LR_REDUCTIONS, LR_REDUCTION_FACTOR, EVAL_INTERVAL, BATCH_SIZE, GRAD_ACCUM_STEPS};
use log::{debug};
use std::path::Path;
...
impl Default for Cli {
    fn default() -> Self {
        Self {
            ...
            vocab_path: unsafe { BPE_VOCAB_PATH.clone() },
